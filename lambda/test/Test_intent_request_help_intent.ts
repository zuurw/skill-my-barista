...
import { HELP_MESSAGES } from '../src/Constants';
import { helpIntentRequest } from './Requests';
...
describe('skill-coffee-recipes Test - IntentRequest HelpIntent', () => {
  before(() => {
    return new Promise((resolve, reject) => {
      Skill(helpIntentRequest, null, (error, responseEnvelope) => {
  ...
  it('it responses with one of sentences', () => {
    assertion.checkOutputSpeechContainsList(skillResponse, HELP_MESSAGES);
  });
});