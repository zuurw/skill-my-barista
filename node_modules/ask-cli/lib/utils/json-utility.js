...
module.exports = {
    ...
    insertObjectToObject: writePropertyToJsonObject,
...
function writeToProperty(filePath, propertyPathArray, writeObject) {
    ...
    writePropertyToJsonObject(jsonObject, propertyPathArray, writeObject);
...
function writePropertyToJsonObject(jsonObject, propertyPathArray, writeObject) {
    let targetObject = jsonObject;
    for (let index = 0; index < propertyPathArray.length - 1; index++) {
        if (!targetObject.hasOwnProperty(propertyPathArray[index])) {
