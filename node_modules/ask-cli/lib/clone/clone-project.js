...
function clone(newProjectRootPath, skillId, skillInfo, profile) {
    _createProjectDirectory(newProjectRootPath, skillInfo);
...
// Private
function _createProjectDirectory(newProjectRootPath, skillInfo) {
    if (fs.existsSync(newProjectRootPath)) {
        console.warn('[Warn]: Project with same name existed. Project will be overwritten.\n');
